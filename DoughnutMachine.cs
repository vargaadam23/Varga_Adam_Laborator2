...
namespace Varga_Adam_Laborator2
{
    class DoughnutMachine
    {
        ...
        private void InitializeComponent()// initializare
        {
            this.doughnutTimer = new DispatcherTimer();
            this.doughnutTimer.Tick += new System.EventHandler(this.doughnutTimer_Tick);
        }
        public DoughnutMachine() //constructor dougnutmcn
        {
            InitializeComponent();
        }

        private void doughnutTimer_Tick(object sender, EventArgs e) //timer pt even handler
        {
    ...
    class Doughnut
    {
        ...
        public Doughnut(DoughnutType aFlavor) // constr
        {
